...
def ms_to_numpy(ms_file_obj):
    """Reads in a ms file object and outputs the positions and the genotypes.
    ...
    data = np.array([list(line.strip()) for line in ms_file_obj], dtype=np.uint8)
